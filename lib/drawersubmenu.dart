...
class ExpenMenu extends StatefulWidget {
  const ExpenMenu({super.key});

  @override
  State<ExpenMenu> createState() => _ExpenMenuState();
}

class _ExpenMenuState extends State<ExpenMenu> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Expenson Drawer"),
      ),
      drawer: Drawer(
        ...
        child: ListView(
          ...
          children: [
            ...
            //   //   Navigator.push(
            //   //     context,
            //   //     new MaterialPageRoute(builder: (context) => new DrawerHome()),
            //   //   );
            //   // }),
            // ),
          ],
